...
```{=html}
<script type="text/javascript" src="https://cdnjs.buymeacoffee.com/1.0.0/button.prod.min.js" data-name="bmc-button" data-slug="rappa753" data-color="#06436e" data-emoji="☕"  data-font="Lato" data-text="Support this free book" data-outline-color="#ffffff" data-font-color="#ffffff" data-coffee-color="#FFDD00" data-height="40px" ></script>
```

:::

Also, if you're interested in working with me, I'm open to freelance work. You can book an appointment with me on [Calendly](https://calendly.com/r-a/30min).
