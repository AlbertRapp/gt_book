...
**This is currently still work in progress. First drafts of Chapters 1-3 are finished. Feedback is welcome.**
...
As of right now (Quarto `v1.2.267` & `{gt}` `v0.7.0.9000 Github (rstudio/gt@a4e108c)`), Quarto's default theme can interact with your `{gt}` table and change its theme.
...
Just so you're sure what versions I'm using.
Here's my session info and my Quarto version.
